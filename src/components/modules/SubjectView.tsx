...
export default function SubjectView({ subject, semesterCode }: SubjectViewProps) {
  ...
  const handleDownload = (resId: string, title: string) => {
    ...
    // Local increment logic or fetch to views API in the future
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-panel p-8 rounded-3xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-slate-500">Credits: {subject.credits}</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="glass-panel p-6 rounded-2xl space-y-3">
            <h3 className="text-sm font-bold text-slate-200 border-b border-white/5 pb-2">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-200">Unit Study Materials</h3>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="p-2 text-slate-600 hover:text-amber-500 hover:bg-white/5 rounded-lg transition-all"
                      title="Report file"
                    >
